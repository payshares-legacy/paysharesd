...
create_path_test = (pth) ->
  return (done) ->
    ...
    sent = "TODO: need to patch payshares-lib"
    ...
    # self.server.clear_logs() "TODO: need to patch payshares-lib"
    ...
    pf.on "update", propagates (m) ->                                      # <--
      ...
      if updates == 2
        # "TODO: need to patch payshares-lib"

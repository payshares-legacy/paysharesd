...
bool transResultInfo (TER terCode, std::string& strToken, std::string& strHuman)
{
    ...
    } transResultInfoA[] =
    {
        ...
        {   tecNO_DST,              "tecNO_DST",                "Destination does not exist. Send XPR to create it."    },
        {   tecNO_DST_INSUF_XPR,    "tecNO_DST_INSUF_XPR",      "Destination does not exist. Too little XPR sent to create it."     },
        ...
        {   tecUNFUNDED_ADD,        "tecUNFUNDED_ADD",          "Insufficient XPR balance for WalletAdd."               },
        {   tecUNFUNDED_OFFER,      "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."           },
        {   tecUNFUNDED_PAYMENT,    "tecUNFUNDED_PAYMENT",      "Insufficient XPR balance to send."                     },
        ...
        {   temBAD_FEE,             "temBAD_FEE",               "Invalid fee, negative or not XPR."                     },
        ...
        {   temBAD_SEND_XPR_LIMIT,      "temBAD_SEND_XPR_LIMIT",        "Malformed: Limit quality is not allowed for XPR to XPR."       },
        {   temBAD_SEND_XPR_MAX,        "temBAD_SEND_XPR_MAX",          "Malformed: Send max is not allowed for XPR to XPR."            },
        {   temBAD_SEND_XPR_NO_DIRECT,  "temBAD_SEND_XPR_NO_DIRECT",    "Malformed: No Ripple direct is not allowed for XPR to XPR."    },
        {   temBAD_SEND_XPR_PARTIAL,    "temBAD_SEND_XPR_PARTIAL",      "Malformed: Partial payment is not allowed for XPR to XPR."     },
        {   temBAD_SEND_XPR_PATHS,      "temBAD_SEND_XPR_PATHS",        "Malformed: Paths are not allowed for XPR to XPR."              },

...
bool transResultInfo (TER terCode, std::string& strToken, std::string& strHuman)
{
    ...
    } transResultInfoA[] =
    {
        ...
        {   tecNO_DST,              "tecNO_DST",                "Destination does not exist. Send XPS to create it."    },
        {   tecNO_DST_INSUF_XPS,    "tecNO_DST_INSUF_XPS",      "Destination does not exist. Too little XPS sent to create it."     },
        ...
        {   tecUNFUNDED_ADD,        "tecUNFUNDED_ADD",          "Insufficient XPS balance for WalletAdd."               },
        {   tecUNFUNDED_OFFER,      "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."           },
        {   tecUNFUNDED_PAYMENT,    "tecUNFUNDED_PAYMENT",      "Insufficient XPS balance to send."                     },
        ...
        {   temBAD_FEE,             "temBAD_FEE",               "Invalid fee, negative or not XPS."                     },
        ...
        {   temBAD_SEND_XPS_LIMIT,      "temBAD_SEND_XPS_LIMIT",        "Malformed: Limit quality is not allowed for XPS to XPS."       },
        {   temBAD_SEND_XPS_MAX,        "temBAD_SEND_XPS_MAX",          "Malformed: Send max is not allowed for XPS to XPS."            },
        {   temBAD_SEND_XPS_NO_DIRECT,  "temBAD_SEND_XPS_NO_DIRECT",    "Malformed: No Ripple direct is not allowed for XPS to XPS."    },
        {   temBAD_SEND_XPS_PARTIAL,    "temBAD_SEND_XPS_PARTIAL",      "Malformed: Partial payment is not allowed for XPS to XPS."     },
        {   temBAD_SEND_XPS_PATHS,      "temBAD_SEND_XPS_PATHS",        "Malformed: Paths are not allowed for XPS to XPS."              },

...
namespace ripple
{
	...
	PaysharesPrivateKey::PaysharesPrivateKey()
	{

	}

	void PaysharesPrivateKey::fromRandomness()
	{
	...
	void PaysharesPrivateKey::fromPassPhrase(std::string& passPhrase)
	{
		mSeed.resize(crypto_sign_SEEDBYTES);
	...
	uint160 PaysharesPrivateKey::getAccountID() const
	{
	...
	std::string PaysharesPrivateKey::base58Seed() const
	{
	...
	std::string PaysharesPrivateKey::hexPublicKey() const
	{
		// TODO: 
		Blob vch(1, RippleAddress::VER_SEED);

...
namespace ripple
{
	...
	class PaysharesPublicKey : public CBase58Data
	{
		bool    mIsValid;
	...
	public:
		...
		PaysharesPublicKey(const Blob& publicKey, RippleAddress::VersionEncoding type);
		PaysharesPublicKey(const std::string& base58Key, RippleAddress::VersionEncoding type);

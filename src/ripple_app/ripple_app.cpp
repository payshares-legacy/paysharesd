...
int main (int argc, char** argv)
{
    ...
    static_assert (gccver >= 40801,
        "GCC version 4.8.1 or later is required to compile paysharesd.");
#endif

#ifdef _MSC_VER
    static_assert (_MSC_VER >= 1800,
        "Visual Studio 2013 or later is required to compile paysharesd.");
#endif

    static_assert (BOOST_VERSION >= 105500,
        "Boost version 1.55 or later is required to compile paysharesd");

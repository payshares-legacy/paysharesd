    ...
    */
    void accept (SHAMap::pointer set)
    {

        {
            ...
            if (!payshares::gLedgerMaster->ensureSync(mPreviousLedger, true))
            {
            ...
            payshares::gLedgerMaster->beginClosingLedger();
            ...
            bool dbcom = payshares::gLedgerMaster->commitLedgerClose(newLCL);
            if (!dbcom)
            {
